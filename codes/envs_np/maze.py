...
class Maze(NPSyncVecEnv):
    r"""
    网格地图路径规划问题: 状态=导航点位置, 控制量=邻边;
    约定:起点在原点
    """
    ...
    def __init__(
        ...
        sim_step_size_ms: int = 1000,  # 仿真步长(ms)
    ...
    def _make_game_v1(self):
        ...
        self._reward_fns: dict[str, BaseRewardFn] = {
            ...
            for i, rf in enumerate(
                [
                    RF_GoalHeadingAngle(weight=1e-2),
                    # RF_GoalDistance(
                    ...
                    RF_GoalReach(min_distance_m=tc_p_dmin, weight=100),
                    RF_TimeCost(weight=-0.01),  # 代价
                ]
            )
        }

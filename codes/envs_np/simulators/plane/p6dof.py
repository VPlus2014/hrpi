...
from .base import BaseModelGroup, BasePlane
...
class PlaneP6DOF(BasePlane):
            ...
            logr.debug(
                {
                    ...
                    "|Qew|": norm_p(Qew_next.reshape(-1, 4)[0, :]).item(),
    ...
    def _run_ode(
        ...
        """
        dt_s = dt_s * (self.is_alive() & mask[..., None]).astype(self.dtype)
